# TiktokEngagementBot Ruby SDK

The Ruby SDK for the TiktokEngagementBot API. Provides an entity-oriented interface using idiomatic Ruby conventions.
...
client = TiktokEngagementBotSDK.new({
  "apikey" => ENV["TIKTOK-ENGAGEMENT-BOT_APIKEY"],
})
```
...
result, err = client.TiktokEngagementBot(nil).load(
  { "id" => "test01" }, nil
)
...
```
rb/
├── TiktokEngagementBot_sdk.rb       -- Main SDK module
