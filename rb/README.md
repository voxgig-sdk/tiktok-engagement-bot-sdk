...
The Ruby SDK for the TiktokEngagementBot API — an entity-oriented client using idiomatic Ruby conventions.
...
raise a `TiktokEngagementBotError` (a `StandardError` subclass), so wrap
