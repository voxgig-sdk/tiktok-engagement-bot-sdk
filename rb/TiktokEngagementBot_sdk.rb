...
require_relative 'TiktokEngagementBot_types'
...
class TiktokEngagementBotSDK
  ...
  def initialize(options = {})
    ...
    feature_opts = TiktokEngagementBotHelpers.to_map(VoxgigStruct.getprop(@options, "feature"))
    if feature_opts
      featureorder = VoxgigStruct.getpath(@options, "__derived__.featureorder")
      if featureorder.is_a?(Array)
        featureorder.each do |fname|
          fopts = TiktokEngagementBotHelpers.to_map(feature_opts[fname])
          if fopts && fopts["active"] == true
            utility.feature_add.call(@_rootctx, TiktokEngagementBotFeatures.make_feature(fname))
          end
        end
      end
    end
  ...
  def get_utility
    TiktokEngagementBotUtility.copy(@_utility)
  end
  ...
  def prepare(fetchargs = {})
    ...
    ctrl = TiktokEngagementBotHelpers.to_map(VoxgigStruct.getprop(fetchargs, "ctrl")) || {}
    ...
    params = TiktokEngagementBotHelpers.to_map(VoxgigStruct.getprop(fetchargs, "params")) || {}
    query = TiktokEngagementBotHelpers.to_map(VoxgigStruct.getprop(fetchargs, "query")) || {}
  ...
  def op_denied(op)
    ...
    {
      "ok" => false,
      "err" => TiktokEngagementBotError.new(
        "#{op}_allow",
  ...
  def raw_request(fetchargs = {})
    ...
    rescue TiktokEngagementBotError => err
    ...
    if fetched.is_a?(Hash)
      status = TiktokEngagementBotHelpers.to_int(VoxgigStruct.getprop(fetched, "status"))
  ...
  def graphql(query, variables = nil, ctrl = nil)
    ...
    if errors.is_a?(Array) && !errors.empty?
      ...
      res["ok"] = false
      res["err"] = TiktokEngagementBotError.new(
        "graphql_error", "TiktokEngagementBotSDK: graphql: #{msg}")
      res["graphql"] = errors
    end
  ...
  def self.test(testopts = nil, sdkopts = nil)
    ...
    sdk = TiktokEngagementBotSDK.new(sdkopts)
    sdk.mode = "test"
    sdk
  end
end
