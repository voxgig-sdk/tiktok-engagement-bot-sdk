...
#      offline in seeded test mode (TiktokEngagementBotSDK.test) against the real
...
class ReadmeExamplesTest < Minitest::Test
  ...
  SDK = File.join(__dir__, "..", "TiktokEngagementBot_sdk.rb")
  SDK_CLASS = "TiktokEngagementBotSDK"
  ...
  SDK_BASE = "TiktokEngagementBot_sdk"
