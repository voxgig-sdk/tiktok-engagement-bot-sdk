...
from tiktokengagementbot_sdk.utility import register

# Load features
from tiktokengagementbot_sdk.feature.base_feature import TiktokEngagementBotBaseFeature
from tiktokengagementbot_sdk.features import _has_feature, _make_feature
...
class TiktokEngagementBotSDK:
    ...
    def __init__(self, options=None):
        ...
        utility = TiktokEngagementBotUtility()
        self._utility = utility

        from tiktokengagementbot_sdk.config import shared_config
    ...
    def get_utility(self):
        return TiktokEngagementBotUtility.copy(self._utility)
    ...
    def graphql(self, query, variables=None, ctrl=None):
        ...
        if isinstance(errors, list) and 0 < len(errors):
            ...
            res["ok"] = False
            res["err"] = Exception("TiktokEngagementBotSDK: graphql: " + str(msg))
            res["graphql"] = errors
    ...
    def Engagement(self, data=None) -> "EngagementEntity":
        ...
        from tiktokengagementbot_sdk.entity.engagement_entity import EngagementEntity
        return EngagementEntity(self, data)



    @classmethod
    def test(cls, testopts=None, sdkopts=None) -> "TiktokEngagementBotSDK":
        if sdkopts is None:
            sdkopts = {}
