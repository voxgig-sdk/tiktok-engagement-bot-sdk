...
from tiktokengagementbot_sdk.tiktokengagementbot_types import (
    Engagement,
...
class EngagementEntity:
    ...
    def make(self):
        ...
        for k, v in self._entopts.items():
            opts[k] = v
        return EngagementEntity(self._client, opts)
    ...
    def create(self, reqdata: EngagementCreateData, ctrl=None) -> Engagement:
        utility = self._utility
