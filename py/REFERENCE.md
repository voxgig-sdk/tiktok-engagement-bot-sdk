# TiktokEngagementBot Python SDK Reference

Complete API reference for the TiktokEngagementBot Python SDK.
...
#### `TiktokEngagementBotSDK.test(testopts=None, sdkopts=None)`
