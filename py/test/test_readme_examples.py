# TiktokEngagementBot SDK — documentation python-examples COMPLETENESS gate.
#
...
#      SDK (mentions TiktokEngagementBotSDK) OR drives a client/sdk variable the narrative
#      built earlier ("client." / "sdk."). A constructing block is rewritten so
#      both TiktokEngagementBotSDK(...) and TiktokEngagementBotSDK.test(...) become
#      TiktokEngagementBotSDK.test({"entity": {...}}) seeding one mock record (id "test01")
...
_SDK_MODULE = "tiktokengagementbot_sdk"
_SDK_CLASS = "TiktokEngagementBotSDK"
