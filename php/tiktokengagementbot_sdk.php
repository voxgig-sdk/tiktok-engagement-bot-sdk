...
class TiktokEngagementBotSDK
{
    ...
    public function __construct(array $options = [])
    {
        ...
        $feature_opts = TiktokEngagementBotHelpers::to_map(Struct::getprop($this->options, "feature"));
        if ($feature_opts) {
            $featureorder = Struct::getpath($this->options, "__derived__.featureorder");
            if (is_array($featureorder)) {
                foreach ($featureorder as $fname) {
                    $fopts = TiktokEngagementBotHelpers::to_map($feature_opts[$fname] ?? null);
                    if ($fopts && isset($fopts["active"]) && $fopts["active"] === true) {
                        ...
                        if (!TiktokEngagementBotFeatures::has_feature($fname)) {
                        ...
                        ($utility->feature_add)($this->_rootctx, TiktokEngagementBotFeatures::make_feature($fname));
                    }
                }
            }
        }
    ...
    {
        return TiktokEngagementBotUtility::copy($this->_utility);
    }
    ...
    public function prepare(array $fetchargs = []): mixed
    {
        ...
        $ctrl = TiktokEngagementBotHelpers::to_map(Struct::getprop($fetchargs, "ctrl")) ?? [];
        ...
        $params = TiktokEngagementBotHelpers::to_map(Struct::getprop($fetchargs, "params")) ?? [];
        $query = TiktokEngagementBotHelpers::to_map(Struct::getprop($fetchargs, "query")) ?? [];
    ...
    private function op_denied(string $op): array
    {
        ...
        return [
            "ok" => false,
            "err" => new TiktokEngagementBotError($op . "_allow",
                "TiktokEngagementBotSDK: " . $op . ": operation not allowed by" .
    ...
    private function raw_request(array $fetchargs = []): mixed
    {
        ...
        if (is_array($fetched)) {
            $status = TiktokEngagementBotHelpers::to_int(Struct::getprop($fetched, "status"));
    ...
    public function graphql(string $query, ?array $variables = null, ?array $ctrl = null): mixed
    {
        ...
        if (is_array($errors) && 0 < count($errors)) {
            ...
            $res["ok"] = false;
            $res["err"] = new TiktokEngagementBotError("graphql_error",
                "TiktokEngagementBotSDK: graphql: " . $msg);
            $res["graphql"] = $errors;
        }
    ...
    public function Engagement($data = null)
    {
        ...
        if ($data === null) {
            if ($this->_engagement === null) {
                $this->_engagement = new EngagementEntity($this, null);
            }
            return $this->_engagement;
        }
        return new EngagementEntity($this, $data);
    }
    ...
    public static function test(?array $testopts = null, ?array $sdkopts = null): self
    {
        ...
        $sdk = new TiktokEngagementBotSDK($sdkopts);
        $sdk->mode = "test";
        return $sdk;
    }
}
