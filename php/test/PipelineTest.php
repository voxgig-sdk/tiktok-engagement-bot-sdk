...
// TiktokEngagementBot SDK pipeline test
//
...
{
    private static function utility(): TiktokEngagementBotUtility
    {
        return new TiktokEngagementBotUtility();
    }
    ...
    private static function ctx(array $over = []): TiktokEngagementBotContext
    {
        $utility = $over['utility'] ?? self::utility();
        $client = $over['client'] ?? new PlClient(['base' => 'http://h']);
        $ctx = new TiktokEngagementBotContext([
            'client' => $client,
            'utility' => $utility,
        ], null);
        $ctx->op = new TiktokEngagementBotOperation(['name' => 'load', 'entity' => 'x']);
        foreach ($over as $k => $v) {
    ...
    {
        return ($err instanceof TiktokEngagementBotError) ? $err->sdk_code : '';
    }
    ...
    public function test_make_point_rejects_a_disallowed_operation(): void
    {
        ...
        $ctx->op = new TiktokEngagementBotOperation(['name' => 'nope', 'entity' => 'x']);
        [$point, $err] = TiktokEngagementBotMakePoint::call($ctx);
    ...
    public function test_make_point_rejects_an_operation_with_no_endpoints(): void
    {
        ...
        $ctx->op = new TiktokEngagementBotOperation(['name' => 'load', 'entity' => 'x', 'points' => []]);
        [$point, $err] = TiktokEngagementBotMakePoint::call($ctx);
        $this->assertNull($point);
    ...
    public function test_make_point_returns_the_single_point(): void
    {
        ...
        $ctx = self::ctx(['options' => ['allow' => ['op' => 'load,list,create,update,remove']]]);
        $ctx->op = new TiktokEngagementBotOperation(['name' => 'load', 'entity' => 'x', 'points' => [$point]]);
        [$got, $err] = TiktokEngagementBotMakePoint::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TiktokEngagementBotSpec(['method' => 'GET']);
        $ctx = self::ctx();
        $ctx->out['spec'] = $preset;
        [$got, $err] = TiktokEngagementBotMakeSpec::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_response_guards_missing_spec_response_result(): void
    {
        $ctx = self::ctx([
            'spec' => null,
            'response' => new TiktokEngagementBotResponse([]),
            'result' => new TiktokEngagementBotResult([]),
        ]);
        [, $err] = TiktokEngagementBotMakeResponse::call($ctx);
        $this->assertSame('response_no_spec', self::code($err));

        $ctx = self::ctx([
            'spec' => new TiktokEngagementBotSpec([]),
            'response' => null,
            'result' => new TiktokEngagementBotResult([]),
        ]);
        [, $err] = TiktokEngagementBotMakeResponse::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'spec' => new TiktokEngagementBotSpec(['step' => 's']),
            'response' => new TiktokEngagementBotResponse(self::resp(404, null, ['x-a' => '1'])),
            'result' => new TiktokEngagementBotResult([]),
        ]);
        [, $err] = TiktokEngagementBotMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_2xx_parses_the_body_and_marks_ok(): void
    {
        $ctx = self::ctx([
            'spec' => new TiktokEngagementBotSpec(['step' => 's']),
            'response' => new TiktokEngagementBotResponse(self::resp(200, ['v' => 1])),
            'result' => new TiktokEngagementBotResult([]),
        ]);
        [, $err] = TiktokEngagementBotMakeResponse::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_response_records_to_ctrl_explain_when_explain_is_on(): void
    {
        $ctx = self::ctx([
            'spec' => new TiktokEngagementBotSpec(['step' => 's']),
            'response' => new TiktokEngagementBotResponse(self::resp(200, ['v' => 2])),
            'result' => new TiktokEngagementBotResult([]),
        ]);
        $ctx->ctrl->explain = ['on' => true];
        TiktokEngagementBotMakeResponse::call($ctx);
    ...
    {
        $preset = new TiktokEngagementBotResponse(self::resp(299));
        $ctx = self::ctx([
            'spec' => new TiktokEngagementBotSpec([]),
            'response' => new TiktokEngagementBotResponse([]),
            'result' => new TiktokEngagementBotResult([]),
        ...
        [$got, $err] = TiktokEngagementBotMakeResponse::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null, 'result' => new TiktokEngagementBotResult([])]);
        [, $err] = TiktokEngagementBotMakeResult::call($ctx);
        $this->assertSame('result_no_spec', self::code($err));

        $ctx = self::ctx(['spec' => new TiktokEngagementBotSpec([]), 'result' => null]);
        [, $err] = TiktokEngagementBotMakeResult::call($ctx);
    ...
    public function test_make_result_list_op_wraps_resdata_into_entity_instances(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TiktokEngagementBotSpec(['step' => 's']),
            'result' => new TiktokEngagementBotResult(['ok' => true, 'resdata' => [['a' => 1], ['a' => 2]]]),
        ]);
        $ctx->op = new TiktokEngagementBotOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TiktokEngagementBotMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    public function test_make_result_empty_list_yields_empty_resdata(): void
    {
        ...
        $ctx = self::ctx([
            'entity' => $entity,
            'spec' => new TiktokEngagementBotSpec(['step' => 's']),
            'result' => new TiktokEngagementBotResult(['ok' => true, 'resdata' => []]),
        ]);
        $ctx->op = new TiktokEngagementBotOperation(['name' => 'list', 'entity' => 'x']);
        [$result, $err] = TiktokEngagementBotMakeResult::call($ctx);
        $this->assertNull($err);
    ...
    {
        $preset = new TiktokEngagementBotResult(['ok' => true]);
        $ctx = self::ctx([
            'spec' => new TiktokEngagementBotSpec([]),
            'result' => new TiktokEngagementBotResult([]),
        ]);
        $ctx->out['result'] = $preset;
        [$got, $err] = TiktokEngagementBotMakeResult::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    public function test_make_request_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TiktokEngagementBotMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $boom = new TiktokEngagementBotError('boom', 'boom');
        $utility->fetcher = function (TiktokEngagementBotContext $_c, string $_u, array $_f) use ($boom): array {
            return [null, $boom];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TiktokEngagementBotSpec(['step' => 's', 'method' => 'GET', 'base' => 'http://h', 'parts' => ['a']]),
        ]);
        [$response, $err] = TiktokEngagementBotMakeRequest::call($ctx);
        $this->assertNull($err);
    ...
    {
        $utility = self::utility();
        $utility->fetcher = function (TiktokEngagementBotContext $_c, string $_u, array $_f): array {
            return [null, null];
        };
        $ctx = self::ctx([
            'utility' => $utility,
    ...
    public function test_make_request_a_normal_transport_response_is_wrapped(): void
    {
        ...
        [$response, $err] = TiktokEngagementBotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertInstanceOf(TiktokEngagementBotResponse::class, $response);
    ...
    public function test_make_request_records_the_fetchdef_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->explain = ['on' => true];
        TiktokEngagementBotMakeRequest::call($ctx);
    ...
    {
        $utility = self::utility();
        $utility->make_fetch_def = function (TiktokEngagementBotContext $c): array {
            return [null, $c->make_error('fetchdef_boom', 'boom')];
        };
        $ctx = self::ctx([
            'utility' => $utility,
            'spec' => new TiktokEngagementBotSpec(['step' => 's', 'method' => 'GET']),
        ]);
        [$response, $err] = TiktokEngagementBotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertNotNull($response->err);
    ...
    {
        $preset = new TiktokEngagementBotResponse(self::resp(201));
        $ctx = self::ctx(['spec' => new TiktokEngagementBotSpec([])]);
        $ctx->out['request'] = $preset;
        [$got, $err] = TiktokEngagementBotMakeRequest::call($ctx);
        $this->assertNull($err);
        $this->assertSame($preset, $got);
    }
    ...
    {
        $ctx = self::ctx(['spec' => null]);
        [, $err] = TiktokEngagementBotMakeFetchDef::call($ctx);
    ...
    public function test_make_fetch_def_serialises_body_and_inits_missing_result(): void
    {
        ...
        [$fetchdef, $err] = TiktokEngagementBotMakeFetchDef::call($ctx);
        $this->assertNull($err);
    ...
    {
        $ctx = self::ctx(['result' => new TiktokEngagementBotResult(['ok' => true, 'resdata' => 42])]);
        $this->assertSame(42, TiktokEngagementBotDone::call($ctx));
    }

    public function test_done_raises_the_error_when_not_ok(): void
    {
        $ctx = self::ctx(['result' => new TiktokEngagementBotResult(['ok' => false])]);
        $this->expectException(TiktokEngagementBotError::class);
        TiktokEngagementBotDone::call($ctx);
    }

    public function test_make_error_returns_resdata_when_ctrl_throw_is_false(): void
    {
        $ctx = self::ctx(['result' => new TiktokEngagementBotResult(['ok' => false, 'resdata' => 'fallback'])]);
        $ctx->ctrl->throw_err = false;
        $this->assertSame('fallback', TiktokEngagementBotMakeError::call($ctx, null));
    }
    ...
    public function test_make_error_records_to_ctrl_explain(): void
    {
        ...
        $ctx->ctrl->throw_err = false;
        $ctx->ctrl->explain = ['on' => true];
        TiktokEngagementBotMakeError::call($ctx, null);
    ...
    public function test_feature_add_appends_in_call_order(): void
    {
        ...
        $a = new TiktokEngagementBotBaseFeature();
        $b = new TiktokEngagementBotBaseFeature();
        TiktokEngagementBotFeatureAdd::call($ctx, $a);
        TiktokEngagementBotFeatureAdd::call($ctx, $b);
        $this->assertSame([$a, $b], $client->features);
    }

    private static function named_feature(string $name): TiktokEngagementBotBaseFeature
    {
        $f = new TiktokEngagementBotBaseFeature();
        $f->name = $name;
        return $f;
    }
    ...
    public function test_feature_add_ordering_before_after_replace(): void
    {
        ...
        TiktokEngagementBotFeatureAdd::call($ctx, self::named_feature('a'));
        TiktokEngagementBotFeatureAdd::call($ctx, self::named_feature('b'));
        $this->assertSame(['a', 'b'], $names());

        $before = self::named_feature('z1');
        $before->_options = ['__before__' => 'b'];
        TiktokEngagementBotFeatureAdd::call($ctx, $before);
        $this->assertSame(['a', 'z1', 'b'], $names());

        $after = self::named_feature('z2');
        $after->_options = ['__after__' => 'a'];
        TiktokEngagementBotFeatureAdd::call($ctx, $after);
        $this->assertSame(['a', 'z2', 'z1', 'b'], $names());

        $replace = self::named_feature('z3');
        $replace->_options = ['__replace__' => 'z1'];
        TiktokEngagementBotFeatureAdd::call($ctx, $replace);
        ...
        TiktokEngagementBotFeatureAdd::call($ctx, $miss);
    ...
    private static function auth_ctx(array $options, ?TiktokEngagementBotSpec $spec): TiktokEngagementBotContext
    {
    ...
    private static function auth_bags(): TiktokEngagementBotSpec
    {
        return new TiktokEngagementBotSpec(['headers' => [], 'query' => []]);
    }
    ...
    private static function auth_probe(array $options): ?array
    {
        ...
        TiktokEngagementBotPrepareAuth::call($ctx);
    ...
    public function test_prepare_auth_guards_a_missing_spec(): void
    {
        ...
        [, $err] = TiktokEngagementBotPrepareAuth::call($ctx);
    ...
    {
        $ctx = self::ctx([
            'response' => new TiktokEngagementBotResponse(['headers' => null]),
            'result' => new TiktokEngagementBotResult([]),
        ]);
        TiktokEngagementBotResultHeaders::call($ctx);
    ...
    public function test_result_body_skips_parsing_when_the_body_is_absent(): void
    {
        ...
        TiktokEngagementBotResultBody::call($ctx);
