...
// TiktokEngagementBot SDK — documentation example COMPLETENESS GATE.
//
...
//      EXECUTED offline in seeded test mode (TiktokEngagementBotSDK::test)
...
{
    private const SDK_CLASS = 'TiktokEngagementBotSDK';
    ...
    private const SDK_BASE = 'tiktokengagementbot_sdk';
    ...
    public function test_php_examples_run_offline(): void
    {
        $ran = 0;
        $failures = [];
        $sdk = __DIR__ . '/../tiktokengagementbot_sdk.php';
        foreach ($this->phpBlocks() as $blk) {
