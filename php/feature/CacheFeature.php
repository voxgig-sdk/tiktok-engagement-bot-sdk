...
// TiktokEngagementBot SDK cache feature
...
class TiktokEngagementBotCacheFeature extends TiktokEngagementBotBaseFeature
{
    ...
    private function _through(TiktokEngagementBotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
