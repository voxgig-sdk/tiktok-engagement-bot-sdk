...
// TiktokEngagementBot SDK clienttrack feature
...
class TiktokEngagementBotClienttrackFeature extends TiktokEngagementBotBaseFeature
{
    ...
    public function PostConstruct(TiktokEngagementBotContext $_ctx): void
    {
        if (!$this->active) {
            return;
        }
    ...
    private function _name(): string
    {
        ...
        $name = (is_string($name) && $name !== '') ? $name : 'TiktokEngagementBot-SDK';
