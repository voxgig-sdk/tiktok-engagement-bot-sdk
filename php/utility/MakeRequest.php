...
// TiktokEngagementBot SDK utility: make_request

require_once __DIR__ . '/../core/Response.php';
require_once __DIR__ . '/../core/Result.php';

class TiktokEngagementBotMakeRequest
{
    public static function call(TiktokEngagementBotContext $ctx): array
    {
        ...
        if ($fetch_err) {
            ...
            $response = new TiktokEngagementBotResponse(['err' => $ctx->make_error('request_no_response', 'response: undefined')]);
        } elseif (is_array($fetched)) {
            $response = new TiktokEngagementBotResponse($fetched);
        } else {
