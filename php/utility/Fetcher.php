...
class TiktokEngagementBotFetcher
{
    ...
    public const DEFAULT_USER_AGENT = 'Mozilla/5.0 (compatible; TiktokEngagementBotSDK/1.0)';
    ...
    public static function call(TiktokEngagementBotContext $ctx, string $fullurl, array $fetchdef): array
    {
