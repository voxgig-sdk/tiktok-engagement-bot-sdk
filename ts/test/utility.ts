...
function envOverride(m: Record<string, any>) {
  if (
    'TRUE' === process.env.TIKTOKENGAGEMENTBOT_TEST_LIVE ||
    'TRUE' === process.env.TIKTOKENGAGEMENTBOT_TEST_OVERRIDE
  ) {
  ...
  m.TIKTOKENGAGEMENTBOT_TEST_EXPLAIN = process.env.TIKTOKENGAGEMENTBOT_TEST_EXPLAIN || m.TIKTOKENGAGEMENTBOT_TEST_EXPLAIN
