...
function envOverride(m) {
    if ('TRUE' === process.env.TIKTOK_ENGAGEMENT_BOT_TEST_LIVE ||
        'TRUE' === process.env.TIKTOK_ENGAGEMENT_BOT_TEST_OVERRIDE) {
    ...
    m.TIKTOK_ENGAGEMENT_BOT_TEST_EXPLAIN = process.env.TIKTOK_ENGAGEMENT_BOT_TEST_EXPLAIN || m.TIKTOK_ENGAGEMENT_BOT_TEST_EXPLAIN;
    return m;
}
