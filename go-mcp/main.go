// Command TiktokEngagementBot-mcp is an MCP server exposing the TiktokEngagementBot
// SDK as MCP tools.
//
// Two tools are registered:
//
//	TiktokEngagementBot_list  — list records of an entity
//	TiktokEngagementBot_load  — load a single record of an entity
//
