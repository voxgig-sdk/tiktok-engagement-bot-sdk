...
from projectname_sdk.core.control import TiktokEngagementBotControl
...
class TiktokEngagementBotContext:
    def __init__(self, ctxmap=None, basectx=None):
        ...
        # Ctrl
        self.ctrl = TiktokEngagementBotControl()
        ...
        if isinstance(sp, TiktokEngagementBotSpec):
            self.spec = sp
        elif basectx is not None:
        ...
        if isinstance(r, TiktokEngagementBotResult):
            self.result = r
        elif basectx is not None:
        ...
        if isinstance(rp, TiktokEngagementBotResponse):
            self.response = rp
        elif basectx is not None:
    ...
    def resolve_op(self, opname):
        ...
        if opname == "":
            return TiktokEngagementBotOperation({})
        ...
        op = TiktokEngagementBotOperation({
            "entity": entname,
            "name": opname,
            "input": inpt,
            "points": points,
    ...
    def make_error(self, code, msg):
        return TiktokEngagementBotError(code, msg, self)
