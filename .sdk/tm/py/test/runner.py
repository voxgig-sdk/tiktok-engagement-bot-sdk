...
class TiktokEngagementBotTestRunner:
    ...
    @staticmethod
    def env_override(m):
        live = TiktokEngagementBotTestRunner.getenv("PROJECTENV_TEST_LIVE")
        override = TiktokEngagementBotTestRunner.getenv("PROJECTENV_TEST_OVERRIDE")
        ...
        explain = TiktokEngagementBotTestRunner.getenv("PROJECTENV_TEST_EXPLAIN")
