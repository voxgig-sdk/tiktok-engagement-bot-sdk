# TiktokEngagementBot SDK feature corpus test
#
...
def _client(kase):
    ...
    TiktokEngagementBotSDK(...), not TiktokEngagementBotSDK.test(...): the `test` feature is
    ...
    return TiktokEngagementBotSDK(opts)
