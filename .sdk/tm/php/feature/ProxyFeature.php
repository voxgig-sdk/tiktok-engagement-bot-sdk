...
// TiktokEngagementBot SDK proxy feature
...
class TiktokEngagementBotProxyFeature extends TiktokEngagementBotBaseFeature
{
    ...
    public function init(TiktokEngagementBotContext $ctx, array $options): void
    {
        ...
        $utility->fetcher = function (TiktokEngagementBotContext $ctx2, string $url2, array $fetchdef) use ($inner): array {
