...
// TiktokEngagementBot SDK rbac feature
...
class TiktokEngagementBotRbacFeature extends TiktokEngagementBotBaseFeature
{
    ...
    private function _required(TiktokEngagementBotContext $ctx): ?string
    {
    ...
    private function _reject(TiktokEngagementBotContext $ctx, string $required): void
    {
    ...
    private function _track(TiktokEngagementBotContext $ctx, string $required, bool $allowed): void
    {
        $client = $this->client;
