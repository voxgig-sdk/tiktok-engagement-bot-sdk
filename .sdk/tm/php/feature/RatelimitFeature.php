...
// TiktokEngagementBot SDK ratelimit feature
...
class TiktokEngagementBotRatelimitFeature extends TiktokEngagementBotBaseFeature
{
    ...
    private function _acquire(TiktokEngagementBotContext $ctx): void
    {
    ...
    private function _track(TiktokEngagementBotContext $_ctx, float $wait_ms): void
    {
        $client = $this->client;
