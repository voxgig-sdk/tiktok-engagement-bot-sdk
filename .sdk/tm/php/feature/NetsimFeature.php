...
// TiktokEngagementBot SDK netsim feature
...
class TiktokEngagementBotNetsimFeature extends TiktokEngagementBotBaseFeature
{
    ...
    private function _simulate(TiktokEngagementBotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
        $opts = $this->options ?? [];
        $this->calls++;
        $call = $this->calls;
    ...
    private function _track(TiktokEngagementBotContext $ctx, array $applied): void
    {
        $client = $this->client;
