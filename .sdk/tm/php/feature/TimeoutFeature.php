...
// TiktokEngagementBot SDK timeout feature
...
class TiktokEngagementBotTimeoutFeature extends TiktokEngagementBotBaseFeature
{
    ...
    private function _with_timeout(TiktokEngagementBotContext $ctx, string $url, array $fetchdef, callable $inner): array
    {
    ...
    private function _track(TiktokEngagementBotContext $_ctx, float $ms): void
    {
        $client = $this->client;
