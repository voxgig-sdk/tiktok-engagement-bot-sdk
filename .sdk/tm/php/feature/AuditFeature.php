...
// TiktokEngagementBot SDK audit feature
...
class TiktokEngagementBotAuditFeature extends TiktokEngagementBotBaseFeature
{
    ...
    private function _emit(TiktokEngagementBotContext $ctx, string $outcome): void
    {
