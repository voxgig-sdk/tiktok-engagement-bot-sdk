...
// TiktokEngagementBot SDK utility type

class TiktokEngagementBotUtility
{
    ...
    public static function copy(TiktokEngagementBotUtility $src): TiktokEngagementBotUtility
    {
        $u = new TiktokEngagementBotUtility();
        $u->clean = $src->clean;
        $u->done = $src->done;
