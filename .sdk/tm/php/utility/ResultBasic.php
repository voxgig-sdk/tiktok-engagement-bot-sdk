...
// TiktokEngagementBot SDK utility: result_basic

class TiktokEngagementBotResultBasic
{
    public static function call(TiktokEngagementBotContext $ctx): ?TiktokEngagementBotResult
    {
        ...
        if ($result && $response) {
            ...
            if ($result->status >= 400) {
                ...
                if ($result->err) {
                    $prev = ($result->err instanceof TiktokEngagementBotError) ? $result->err->msg : (string)$result->err;
