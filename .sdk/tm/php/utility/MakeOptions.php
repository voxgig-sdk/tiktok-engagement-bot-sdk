...
// TiktokEngagementBot SDK utility: make_options

class TiktokEngagementBotMakeOptions
{
    ...
    public static function call(TiktokEngagementBotContext $ctx): array
    {
        ...
        //
        // `TiktokEngagementBotSchema::optspec()` is built from the model:
        ...
        $optspec = TiktokEngagementBotSchema::optspec();
