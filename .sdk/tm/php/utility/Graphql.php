...
// TiktokEngagementBot SDK utility: graphql
//
...
class TiktokEngagementBotGraphql
{
    ...
    // equivalent.
    public static function body(TiktokEngagementBotContext $ctx): mixed
    {
    ...
    public static function errors(TiktokEngagementBotContext $ctx): bool
    {
        $result = $ctx->result;
        $point = $ctx->point;
