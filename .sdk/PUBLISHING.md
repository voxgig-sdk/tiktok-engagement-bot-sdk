...
|---|---|---|
| `ts/` | @voxgig-sdk/tiktok-engagement-bot-sdk | `.github/workflows/publish-ts.yml` |
...
`ts` target it runs:
    ...
    npm trust github @voxgig-sdk/tiktok-engagement-bot-sdk \
      --repository voxgig-sdk/tiktok-engagement-bot-sdk \
      --file publish-ts.yml \
      --allow-publish
...
`npm trust list @voxgig-sdk/tiktok-engagement-bot-sdk` shows the configuration, and
`npm trust revoke @voxgig-sdk/tiktok-engagement-bot-sdk --id=<id>` removes one.
