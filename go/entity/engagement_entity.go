...
type EngagementEntity struct {
	name    string
	client  *core.TiktokEngagementBotSDK
...
func NewEngagementEntity(client *core.TiktokEngagementBotSDK, entopts map[string]any) *EngagementEntity {
	if entopts == nil {
		entopts = map[string]any{}
	}
...
func (e *EngagementEntity) GetName() string { return e.name }
...
func (e *EngagementEntity) MarkDeleted() {
	e.deleted = true
}


// Deleted reports whether a successful Remove has resolved on this instance.
func (e *EngagementEntity) Deleted() bool {
	return e.deleted
}


func (e *EngagementEntity) Make() core.Entity {
	opts := map[string]any{}
	for k, v := range e.entopts {
		opts[k] = v
	}
	return NewEngagementEntity(e.client, opts)
}

func (e *EngagementEntity) Data(args ...any) any {
...
func (e *EngagementEntity) Match(args ...any) any {
	if len(args) > 0 && args[0] != nil {
...
// argument it returns the current data as an Engagement; with an argument it
// sets the data and returns the stored value. It delegates to the untyped Data
// (identical runtime) and converts at the typed boundary.
func (e *EngagementEntity) DataTyped(data ...Engagement) Engagement {
	if len(data) > 0 {
		return typedFrom[Engagement](e.Data(asMap(data[0])))
	}
	return typedFrom[Engagement](e.Data())
}

// MatchTyped mirrors DataTyped for the entity's match filter. The match is a
// partial of the entity, so it round-trips through Engagement (all fields
// optional at the wire level).
func (e *EngagementEntity) MatchTyped(match ...Engagement) Engagement {
	if len(match) > 0 {
		return typedFrom[Engagement](e.Match(asMap(match[0])))
	}
	return typedFrom[Engagement](e.Match())
}
...
func (e *EngagementEntity) Stream(action string, args map[string]any, callopts map[string]any) <-chan any {
	out := make(chan any)
...
func (e *EngagementEntity) Load(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("load", e.name)
}


func (e *EngagementEntity) List(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("list", e.name)
}



func (e *EngagementEntity) Create(reqdata map[string]any, ctrl map[string]any) (any, error) {
	utility := e.utility
...
// EngagementCreateData and returns an Engagement. It delegates to the untyped
// Create (identical runtime) and converts at the typed boundary.
func (e *EngagementEntity) CreateTyped(reqdata EngagementCreateData, ctrl map[string]any) (Engagement, error) {
	res, err := e.Create(asMap(reqdata), ctrl)
	if err != nil {
		return Engagement{}, err
	}
	return typedFrom[Engagement](res), nil
}



func (e *EngagementEntity) Update(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("update", e.name)
}


func (e *EngagementEntity) Remove(_ map[string]any, _ map[string]any) (any, error) {
	return core.UnsupportedOp("remove", e.name)
}


func (e *EngagementEntity) runOp(ctx *core.Context, postDone func()) (any, error) {
	utility := e.utility
