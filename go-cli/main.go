// Command TiktokEngagementBot-cli is a CLI + REPL for the TiktokEngagementBot SDK,
...
const prompt = "tiktok-engagement-bot"

// entitiesHelp is the space-separated entity list shown by /help.
const entitiesHelp = "engagement"
...
func usage(out io.Writer) {
	...
	fmt.Fprintln(out, "Env:      TIKTOK_ENGAGEMENT_BOT_APIKEY (api key), TIKTOK_ENGAGEMENT_BOT_BASE (base url override)")
