...
func registerSDKWords(r *eng.Registry, client *sdk.TiktokEngagementBotSDK) {
...
func runOp(client *sdk.TiktokEngagementBotSDK, op string, query *eng.Value, entityAtom eng.Value) ([]eng.Value, error) {
