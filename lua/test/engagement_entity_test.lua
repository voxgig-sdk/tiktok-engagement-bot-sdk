...
describe("EngagementEntity", function()
  ...
  it("should run basic flow", function()
    ...
    if setup.synthetic_only then
      pending("live entity test uses synthetic IDs from fixture — set TIKTOKENGAGEMENTBOT_TEST_ENGAGEMENT_ENTID JSON to run live")
      return
    end
...
function engagement_basic_setup(extra)
  ...
  local entid_env_raw = os.getenv("TIKTOKENGAGEMENTBOT_TEST_ENGAGEMENT_ENTID")
  ...
  local live = env["TIKTOKENGAGEMENTBOT_TEST_LIVE"] == "TRUE"
  return {
    client = client,
    data = entity_data,
