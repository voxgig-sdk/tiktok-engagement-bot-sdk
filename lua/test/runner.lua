...
function runner.env_override(m)
  local live = runner.getenv("TIKTOKENGAGEMENTBOT_TEST_LIVE")
  local override = runner.getenv("TIKTOKENGAGEMENTBOT_TEST_OVERRIDE")
  ...
  local explain = runner.getenv("TIKTOKENGAGEMENTBOT_TEST_EXPLAIN")
